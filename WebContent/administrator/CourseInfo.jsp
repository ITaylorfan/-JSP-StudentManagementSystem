...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form class="form-horizontal" id="editForm"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="inputCno"
									placeholder="请输入课程号" name="cno" required="" readonly>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="inputStudyTime" class="col-sm-2 control-label">学时</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="inputStudyTime"
									placeholder="请输入学时" name="study_time">
							</div>
						</div>
						<div class="form-group">
					...
					<div class=" panel-body">
						<div class="table-responsive">
							<table class="table table-condensed">
								...
								<tbody id="tbody">
									<c:forEach items="${CourseInfo}" var="ci">
										<tr>
											<td>${ci.cno}</td>
											<td>${ci.cname}</td>
											<td>${ci.study_time}</td>
	...
	<script>
		...
		$("#refresh").click(function(){
			window.location = "../administratorCourseInfoGet"
		})
