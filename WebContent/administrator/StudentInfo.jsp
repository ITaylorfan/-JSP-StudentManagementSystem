...
<body>
				...
				<div class="panel panel-default panel-primary"
					...
					<div class=" panel-body">
						<div class="table-responsive">
							...
							<ul class="pagination">
								<li><a href="../administratorStudentInfoPaging?page=prev"
								...
								<c:forEach items="${StudentInfoPageNum}" var="ci">
									<li class="pageNum"><a
										href="../administratorStudentInfoPaging?page=${ci-1}">${ci}</a></li>
								</c:forEach>


								<li><a href="../administratorStudentInfoPaging?page=next"
	...
	<%
	int current_page=0;
	if(session.getAttribute("StudentInfoCurrentPage")!=null){
		 current_page = (Integer) session.getAttribute("StudentInfoCurrentPage");
	}
	%>
