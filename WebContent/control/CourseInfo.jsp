...
<%@page import="com.front.Bean.MyCourseInfo"%>
...
<%
	/* 解决直接打开当前页面没有值的问题 */
	List<MyCourseInfo> myCourseInfo=(List<MyCourseInfo>) session.getAttribute("MyCourseInfo");
	if (myCourseInfo==null) {
		response.sendRedirect("../courseInfo");
	} 
%>
		...
		<div class="row">
			...
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					...
					<li class="active"><a href="../courseInfo"><span
					...
					<div class=" panel-body">
						<div class="table-responsive">
							<table class="table table-striped table-hover">
								...
								<tbody>
								<c:forEach items="${MyCourseInfo}" var="ci">
									<tr>
										<td>${ci.cno}</td>
										<td>${ci.cname}</td>
										<td>${ci.study_time}</td>
